...
module "rds"{
source = "git::https://github.com/arrvinddev/tf-module-rds.git"
for_each = var.rds
engine_version = each.value["engine_version"]
instance_count = each.value["instance_count"]
instance_class = each.value["instance_class"]   
...
module "elasticache"{
    source = "git::https://github.com/arrvinddev/tf-module-elasticache.git"
...
module "rabbitmq"{
    source = "git::https://github.com/arrvinddev/tf-module-amazon-mq.git"
